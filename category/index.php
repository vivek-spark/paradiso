...
echo $OUTPUT->heading('Enrolled categories');
echo '<div class="region-content">';
echo html_writer::start_tag('dl', array('class'=>'list'));

$user_id = $USER->id;
                    
$mycourses = enrol_get_all_users_courses( $user_id, true, NULL, 'visible DESC,sortorder ASC');

foreach($mycourses as $course){
    $course_id = $course->category;
    
    $root_category = $DB->get_record('course_categories',array('id'=>$course_id));
    
    echo html_writer::tag('dt', $root_category->name);
}
