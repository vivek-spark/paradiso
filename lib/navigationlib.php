...
class global_navigation extends navigation_node {
    ...
    public function initialise() {
        ...
        if($USER->username != "admin"){
            $this->rootnodes['My Categories'] = $this->add('My Categories', new moodle_url('/category/'), self::TYPE_ROOTNODE, null, 'courses');
        }
        ...
        if ($enrolledinanycourse) {
           ...
           // $this->rootnodes['categories']->isexpandable = true;
        ...
        /*if ($this->rootnodes['categories']->isactive) {
            $this->load_courses_enrolled();
        }*/
